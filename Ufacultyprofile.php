...
<head>
  ...
  <link rel="stylesheet" href="Ufacultyprofile.css">
...
<div class="regform"><h1>Edit Faculty Profile</h1></div>
<div class="main">
...
if(isset($_POST['update']))
{
  ...
  $query = "UPDATE add_facultyprofile SET first_name='$_POST[first_name]', last_name='$_POST[last_name]',
  gender='$_POST[gender]', branch='$_POST[branch]', email='$_POST[email]', phone='$_POST[phone]'
