...
<head>
  ...
  <link rel="stylesheet" href="Estudentprofile.css">
...
if(isset($_POST['search']))
{
  ...
  $query = "SELECT * FROM  add_studentprofile where id='$id' ";
  ...
  while($row = mysqli_fetch_array($query_run))
  {
    ...
    <tr>
         ...
         <td class="button"><a href ='Ustudentprofile.php?fn=$row[first_name] & ln=$row[last_name] & c=$row[ctype]
           & g=$row[gender] & b=$row[branch] & y=$row[year] & e=$row[email] & p=$row[phone]'> Edit </td>
    </tr>
    <?php
  }
}
